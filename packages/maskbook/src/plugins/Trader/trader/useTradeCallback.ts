...
import { useTradeCallback as useNativeWrapperCallback } from './native/useTradeCallback'
...
export function useTradeCallback(provider: TradeProvider, tradeComputed: TradeComputed<unknown> | null) {
    ...
    const nativeWrapper = useNativeWrapperCallback(tradeComputed as TradeComputed<NativeTokenWrapper>)
    ...
    if (isNativeTokenWrapper_) return nativeWrapper
